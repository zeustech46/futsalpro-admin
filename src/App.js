...
function App() {
  ...
  const AuthenticatedDashboard = checkAuthentication(Dashboard);
  ...
  const addScheduleButton = (
    <ArgonBox
      ...
      sx={{ cursor: "pointer" }}
    >
      <ArgonButton component={Link} to="/keranjang" color="warning" variant="gradient" size="large">
        <Icon>add</Icon>
