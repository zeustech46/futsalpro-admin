...
import { updatePesananTransaction } from "../../action/PesananAction";
...
class Finish extends Component {
  ...
  render() {
    ...
    const { updatePesananTransactionLoading } = this.props;

    return (
      <Grid container justifyContent="center" alignItems="center" height="100vh">
        <Grid item>
          {updatePesananTransactionLoading ? (
            <Box
              sx={{
                textAlign: "center",
                alignItems: "center",
            ...
            >
              <CircularProgress />
              <ArgonTypography mt={2}>Loading</ArgonTypography>
            </Box>
          ) : (
            <Box
              sx={{
            ...
            >
              ...
              <ArgonBox width={230}>
                <Lottie
                  animationData={
                    transaction_status === "settlement" ? AnimationSuccess : AnimationPending
                  }
                  loop={false}
                />
              </ArgonBox>
              ...
              <ArgonTypography color="text" fontSize={19} mb={1}>
                {transaction_status === "pending" && "Harap Selesaikan Pembayaran"}
              </ArgonTypography>
              <ArgonBox
                display="flex"
                flexDirection="row"
              ...
              <ArgonBox display="flex" flexDirection="row">
                ...
                >
                  {transaction_status === "settlement" ? "lunas" : "pending"}
                </ArgonTypography>
              </ArgonBox>
...
const mapStateToProps = (state) => ({
  updatePesananTransactionLoading: state.PesananReducer.updatePesananTransactionLoading,
});
